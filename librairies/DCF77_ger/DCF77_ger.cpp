...
#include <DCF77_ger.h>       //https://github.com/thijse/Arduino-Libraries/downloads
#include <Time_ger.h>        //http://www.arduino.cc/playground/Code/Time
#include <Utils.h>
...
inline void DCF77::appendSignal(unsigned char signal) {
	Log(signal, DEC);
#ifdef VERBOSE_DEBUG
	Serial.print(" ");Serial.print(bufferPosition); Serial.print("_59 ");
#endif
